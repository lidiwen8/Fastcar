...
<body onload="loadmsg()" background="Images/bg.jpg" style=" background-repeat:no-repeat ;background-size:100% 100%;background-attachment: fixed;">
<div class="container">
    <div class="row">
    ...
    %>
    <form class="form-horizontal col-sm-offset-3" id="loginform" method="post" action="passengerServlet?action=login" onsubmit="return login()">
