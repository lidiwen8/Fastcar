...
<head>
  ...
  <script type="text/javascript">
      $(function(){
          $("#1").click(function(){
              window.location.href='orderServlet?action=findOrderAll';
          });
          $("#2").click(function(){
              window.location.href='orderServlet?action=closeorderbydrivername';
          });
          $("#3").click(function(){
              window.location.href='driverServlet?action=logout';
          });
          $("#4").click(function(){
...
<form class="form-horizontal col-sm-offset-3" id="loginform">
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-2 col-xs-6">
      <button class="btn btn-success" type="button" id="1">选择接新订单</button>
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-2 col-xs-6">
