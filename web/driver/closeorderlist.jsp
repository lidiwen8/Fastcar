...
<nav class="navbar navbar-inverse">
    <p class="navbar-text">司机已结束历史订单信息</p>
</nav>
<div class="container">
    <h2 class="sub-header">${drvier}已结束行程信息分页列表</h2><br>
        ...
        <table class="table table-striped">
            ...
            <c:forEach items="${pb.beanList}" var="cstm">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn-sm edit_btn" onclick="javascript:window.location.href='orderServlet?action=queryOrderByid&id=${cstm.orderid}'"><span class="glyphicon glyphicon-pencil">详情</span></button>
                    </td>
                </tr>
                </tbody>
            </c:forEach>
